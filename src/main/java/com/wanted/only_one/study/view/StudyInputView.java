...
public class StudyInputView {
    ...
    * */
    ...
    private void showCourseList() {
        ...
        System.out.println("1. 선택 목록에 넣을 강좌 고르기");
    ...
    private void showFavList() {
        ...
        System.out.println("====선택 목록 조회 결과====");
    ...
    private void chooseCourseList() {
        System.out.println("---선택 목록 강좌 선택---");
        ...
        if (result != null && result == true) {
            studyOutputView.printSuccess("선택 목록에 강좌 추가 성공! " + result);
        } else {
    ...
    private void showReviewableList() {
        studyOutputView.printMessage("---수강 완료한 강좌 목록 전체 조회---");
    }
// 강좌평 조회는 ShowReview()
